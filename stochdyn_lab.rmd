...
The object that `jags` returns is complicated. `summary()` returns a bunch of information, including the mean and SD, quantiles, R-hat, and effective sample size:

```{r sum1}
summary(j1$BUGSoutput)
```
