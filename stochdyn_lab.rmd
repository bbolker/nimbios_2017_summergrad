...
```
True value `r R0fun(2,1)` vs. estimated `r R0fun(coef(tfit)[1],coef(tfit)[2])`
...
---
From Neal Stephenson's [*Cryptonomicon*](http://cnqzu.com/library/Anarchy%20Folder/Fiction/Stephenson,_Neal/Stephenson,_Neal_-_Cryptonomicon/Neal%20Stephenson%20-%20Cryptonomicon%20v2%20(HTML,%20Fully%20Proofed)/slide58.html):
